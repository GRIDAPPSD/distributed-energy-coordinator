...
def _main():
    ...
    # For the secondary agent
    sec_agent = Secondary_Agent()
    bus_info = {}
    bus_info['30'] = {'idx': 0, 'injection': [0+0j]}
    bus_info['S30C'] = {'idx': 1, 'injection': [0+0j]}
    bus_info['S30C1'] = {'idx': 2, 'injection': [32330+16183j]}
    xfmr_tpx = {}
    xfmr_tpx['XFS30C'] = {'type': 'XFMR', 'idx': 0, 'fr_bus': '30', 'to_bus': 'S30C', 'from':0, 'to':1, 'impedance': [0.006+0.0136j], 'impedance1': [0.012+0.0068j]}

    xfmr_tpx['S30C_1'] = {'type': 'LINE', 'idx': 1,'fr_bus': 'S30C', 'to_bus': 'S30C1', 'from':1, 'to':2, 'impedance': [0.0042+0.0023j]}
    

    agent_bus = '30'
    agent_bus_idx = bus_info[agent_bus]['idx']
    vsrc = [0.98182]
    sec_agent.alpha_area(xfmr_tpx, bus_info, agent_bus, agent_bus_idx, vsrc)
